...
func (ec *executionContext) field_Mutation_createOrder_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewOrder2githubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐNewOrder(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewOrder2githubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐNewOrder(ctx context.Context, v interface{}) (model.NewOrder, error) {
	res, err := ec.unmarshalInputNewOrder(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNOrder2githubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋjanainamaiᚋgoᚑexpertᚑchallengesᚋ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
